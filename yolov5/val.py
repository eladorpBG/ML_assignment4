...
from utils.torch_utils import select_device, smart_inference_mode, smartCrossEntropyLoss
...
def run(
    ...
    if verbose:  # all classes
        ...
        LOGGER.info(f"Results saved to {colorstr('bold', str(save_dir))}")

    print(f"Results: top1_acc: {top1:.3g}, top5_acc: {top5:.3g}, loss: {loss}")
